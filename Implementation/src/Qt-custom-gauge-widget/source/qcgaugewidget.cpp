...
QcColorBand::QcColorBand(QObject *parent, float pos1,
                                         float pos2,  float pos3) :
    QcScaleItem(parent)
{
    QColor tmpColor;
...
void QcColorBand::setColorsSegments(QColor color1, float pos1,
                                    QColor color2, float pos2,
                                    QColor color3, float pos3 )
{
    mBandColors[0].second =  pos1;
    mBandColors[1].second = pos2;
    mBandColors[2].second = pos3;
    mBandColors[0].first =  color1;
    mBandColors[1].first =  color2;
    mBandColors[2].first =  color3;
}
